  ...
  return (
    <>
      <PageHero
        number="S.01"
        eyebrow="Portafolio"
        title="Soluciones médicas para el manejo del dolor"
        lead="Tecnología, equipos e insumos especializados para soluciones de ablación por radiofrecuencia."
        texture
        actions={
          <>
            ...
            <ButtonLink href="/asesoria" variant="outline-dark">
              Solicitar asesoría
            </ButtonLink>
          </>
        }
      ...
      <section id="rfa" className="scroll-mt-24 py-20 sm:py-28">
        <Container>
          <Reveal>
            <SectionHeading
          ...
          <Reveal>
            <div className="grid grid-cols-12 gap-x-6 gap-y-8">
              <div className="col-span-12 lg:col-span-8">
                <h2 className="heading-section text-[1.75rem] text-paper sm:text-[2.5rem]">
