  ...
  return (
    <>
      <PageHero
        ...
        eyebrow="Contacto"
        title="Hablemos"
        lead="Contáctanos para solicitar información sobre productos, disponibilidad, cotizaciones o asesoría."
        aside={
                  ...
                  {channels.map((channel) => {
                    const inner = (
                      <>
                        ...
                        <span className="mt-3 block heading-tile text-[1.375rem] text-navy">
                          {channel.value}
                        </span>
